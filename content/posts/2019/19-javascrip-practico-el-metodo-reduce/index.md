...
description: ""
summary: "Ejemplo práctico de cómo usar el método reduce de Javascript de forma nativa sin el uso de ninguna biblioteca externa"
...
```javascript
const sumDiscount = (invoiceDiscountAmount, nextItem) => 
  invoiceDiscountAmount + (nextItem.price * nextItem.discount);  
```
